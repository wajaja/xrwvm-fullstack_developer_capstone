...
urlpatterns = [
    ...
    path('dealer/<int:dealer_id>/', T.as_view(template_name="index.html"), name='dealer_detail'),
    path('postreview/<int:dealer_id>/', T.as_view(template_name="index.html"), name='post_review'),
